...
namespace WebApp.Controllers
{
    public class FormsController : Controller
    {
        ...
        {
            ViewBag.ComputerSkillId = new SelectList(db.ComputerSkills, "ComputerSkillId", "ComputerSkillName");
            ViewBag.CourseNSeminarId = new SelectList(db.CourseNSeminars, "CourseNSeminarId", "Certificate");
            ViewBag.JobHistoryId = new SelectList(db.JobHistories, "JobHistoryId", "JobHistoryName");
            ViewBag.LangInfoId = new SelectList(db.LangInfos, "LangInfoId", "LangInfoName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "FormId,FirstMidName,LastName,BirthDate,PhoneNumber,Address,MilitaryService,TshirtSize,PantSize,ShoesSize,DrivingLicence,DrivingLicenceClass,ForkliftLicence,CraneOperationLicense,CourseNSeminarId,LangInfoId,ComputerSkillId,WorkingNow,JobChangeReason,JobHistoryId,Ok4Overtime,Ok4ShiftWork,FormResultId")] Form form)
        {
            ...
            ViewBag.ComputerSkillId = new SelectList(db.ComputerSkills, "ComputerSkillId", "ComputerSkillName", form.ComputerSkillId);
            ViewBag.CourseNSeminarId = new SelectList(db.CourseNSeminars, "CourseNSeminarId", "Certificate", form.CourseNSeminarId);
            ViewBag.JobHistoryId = new SelectList(db.JobHistories, "JobHistoryId", "JobHistoryName", form.JobHistoryId);
            ViewBag.LangInfoId = new SelectList(db.LangInfos, "LangInfoId", "LangInfoName", form.LangInfoId);
            return View(form);
        }
